...
sca_nwh1 = sca(94:109,26:41,1:479);
    for a=1:479
        n = sca_nwh1(:,:,a);
        n(isnan(n))=[];
        k=k+1;
...
sf_nwh1 = sf(94:109,26:41,1:479);
   ...
   % annual stacking - 39 years leaving last year out of 40
    ...
    sca_sf_nwh_rp = [r1,r2,r3,r4,r5,r6;p1,p2,p3,p4,p5,p6].'
    csvwrite('sca_sf_nwh_rp.csv',sca_sf_nwh_rp)
  ...
  %  B = table(djfm);
   ...
   % writetable(C,'sf_nwh_jjas.csv')
    D = table(sca_sf_nwh_rp)
    writetable(D,'sca_sf_nwh_rp.csv')
