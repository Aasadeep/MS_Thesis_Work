...
sf_wh1 = sf(112:133,56:77,1:479);
   ...
   % annual stacking - 39 years leaving last year out of 40
    ...
    csvwrite('sf_wh_annual.csv',annual)
    csvwrite('sf_wh_djfm.csv',djfm)
    csvwrite('sf_wh_jjas.csv',jjas)
    ...
    sf_wh_rp = [r1,r2,r3,r4,r5,r6;p1,p2,p3,p4,p5,p6].'
    csvwrite('sf_wh_rp.csv',sf_wh_rp)
