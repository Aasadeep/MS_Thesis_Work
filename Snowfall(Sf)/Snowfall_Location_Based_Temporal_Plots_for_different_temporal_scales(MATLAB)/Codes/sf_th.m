...
sf_th1 = sf(157:178,31:52,1:479);
   ...
   % annual stacking - 39 years leaving last year out of 40
    ...
    sf_th_rp = [r1,r2,r3,r4,r5,r6;p1,p2,p3,p4,p5,p6].'
    csvwrite('sf_th_rp.csv',sf_th_rp)
    
    A = table(annual);
    writetable(A,'sf_th_annual.csv')
    B = table(djfm);
    writetable(B,'sf_th_djfm.csv')
    C = table(jjas);
    writetable(C,'sf_th_jjas.csv')
    D = table(sf_th_rp)
    writetable(D,'sf_th_rp.csv')
